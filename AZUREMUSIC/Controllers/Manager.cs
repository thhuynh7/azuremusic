// ************************************************************************************
// WEB524 Project Template V3 2221 == 10ae7ca4-3fb2-4291-acf4-e88222e3c6c7
    ...
    public class Manager
    {
        ...
        public Manager()
        {
            ...
            var config = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<ArtistBaseViewModels, ArtistAddFormViewModels>();
                ...
                cfg.CreateMap<AlbumBaseViewModels, AlbumAddFormViewModels>();
                ...
                cfg.CreateMap<TrackBaseViewModels, TrackAddFormViewModels>();
                cfg.CreateMap<TrackAddViewModels, Track>();
                cfg.CreateMap<Track, TrackAddViewModels>();
                cfg.CreateMap<Track, TrackAudioViewModels>();
                cfg.CreateMap<TrackWithDetailViewModels, TrackAddFormViewModels>();
                cfg.CreateMap<TrackWithDetailViewModels, TrackEditFormViewModels>();
        ...
        {
            var artists = ds.Artists.OrderBy(o => o.Id);
        ...
        public ArtistWithDetailViewModels ArtistGetById(int? id)
        {
            ...
            var obj = ds.Artists.Include("MediaItems").SingleOrDefault(a => a.Id == id);
            ...
            {
                var result = mapper.Map<Artist, ArtistWithMediaInfoViewModels>(obj);
        ...
        {
            var album = ds.Albums.OrderBy(o => o.Name);
        ...
        public AlbumWithDetailViewModels AlbumAdd(AlbumAddViewModels newAlbum)
        {
            newAlbum.Coordinator = HttpContext.Current.User.Identity.Name;

            var addedAlbum = ds.Albums.Add(mapper.Map<AlbumAddViewModels, Album>(newAlbum));
            ds.SaveChanges();
            return (addedAlbum != null) ? mapper.Map<Album, AlbumWithDetailViewModels>(addedAlbum) : null;
        ...
        public TrackWithDetailViewModels TrackGetById(int? id)
        {
            ...
            else
            {
                ...
                var result = mapper.Map<Track, TrackWithDetailViewModels>(obj);
                result.AlbumNames = obj.Albums.Select(a => a.Name);
                return result;
            }
        }
        public IEnumerable<TrackBaseViewModels> TrackGetAllByArtistId(int? id)
        {
            //fetch the artist
            ...
            return mapper.Map<IEnumerable<Track>, IEnumerable<TrackBaseViewModels>>(tracks.OrderBy(t => t.Name));
        }
        public TrackAudioViewModels TrackAudioGetById(int? id)
        {
            ...
            {
                return mapper.Map<Track, TrackAudioViewModels>(trackAudio);
            }
        ...
        public TrackBaseViewModels TrackAdd(TrackAddViewModels newTrack)
        {
            ...
            ds.SaveChanges();
            return (addedTrack != null) ? mapper.Map<Track, TrackWithDetailViewModels>(addedTrack) : null;
        }
        ...
        public TrackWithDetailViewModels TrackEdit(TrackEditViewModels editedTrack)
        {
